...
const Pagination = ({ itemCount, pageSize, currentPage }: Props) => {
    ...
    const changePage = (page: number) => {
        const params = new URLSearchParams(searchParams.toString()); // ✅ Correctly clone
        params.set('page', page.toString()); // ✅ Only update page param
        router.push('?' + params.toString()); // ✅ Push updated query
    };
