...
const IssuePage = async ({ searchParams }: Props) => {
    ...
    const status = validStatuses.includes(statusParam.status as IssueStatus)
        ? (statusParam.status as IssueStatus)
        : undefined;
...
export const metadata: Metadata = {
    ...
    description:
        'Browse and manage all project issues by status, including open, in-progress, and closed. Filter, track, and prioritize issues for efficient project management.',
};
